...
echo '<p style="font-weight:700;font-size:20px;font-family: Calibri;">FairPrice</p>';
$email = $_COOKIE['cookiee'];
$cold = mysqli_query($dbconfig,"SELECT * FROM gr_cart WHERE item_unique_code LIKE 'fairprice%' AND active_status = '1' AND user_email = '$email'");
...
$compare = mysqli_query($dbconfig,"select * from gr_cart where item_unique_code NOT LIKE 'fairprice%' and active_status='1' and user_email='$email'");
